...
Public Class Notification
    ...
    'TODO: Implement Log4Net or something
    ...
    Function GetImagePath(ImageName As String)
        ...
        Return ImagePath
    End Function
    Private Sub NotificationUI_MouseEnter(sender As Object, e As EventArgs) Handles NotificationUI.MouseEnter
    ...
    Private Sub NotificationUI_MouseLeave(sender As Object, e As EventArgs) Handles NotificationUI.MouseLeave
